...
<!--     <link href='http://fonts.googleapis.com/css?family=Titillium+Web:400,200,300,700,600' rel='stylesheet' type='text/css'>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="<?php echo base_url()?>assets/checkout/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url()?>assets/checkout/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="<?php echo base_url()?>assets/checkout/css/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo base_url()?>assets/checkout/style.css">
    <link rel="stylesheet" href="<?php echo base_url()?>assets/checkout/css/responsive.css">
</head>
<body>
...
<!--                                                     <tr class="shipping">
            ...
            <script src="<?php echo base_url()?>assets/checkout/js/bootstrap.min.js"></script>
