...
<!--     <link href='http://fonts.googleapis.com/css?family=Titillium+Web:400,200,300,700,600' rel='stylesheet' type='text/css'>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="../assets/checkout/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../assets/checkout/css/owl.carousel.css">
    <link rel="stylesheet" href="../assets/checkout/style.css">
    <link rel="stylesheet" href="../assets/checkout/css/responsive.css">
</head>
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-content-right">
                            <div class="woocommerce-info">Login | 
                            </div>
...
<!--                                                     <tr class="shipping">
            ...
            <script src="../assets/checkout/js/bootstrap.min.js"></script>

            <script src="../assets/checkout/js/checkout.js"></script>
        </body>
        </html>